<br/><br/><br/>
<?php $sqlnoticia = $mySQL->runQuery("SELECT * FROM forteap_institucinal WHERE idinstitucinal='".$_GET['id']."'");
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="4">
        <tr>
          <td colspan="3"><h1><em>Editar Institucional</em>
              <input name="opt" type="hidden" id="opt" value="editar" />
              <input name="img_old" type="hidden" id="img_old" value="<?php echo $rsnoticia['imagem']; ?>" />
            <input name="idinstitucinal" type="hidden" id="idinstitucinal" value="<?php echo $rsnoticia['idinstitucinal']; ?>" />
          </h1></td>
        </tr>        
        <tr>
          ...
          <td colspan="2" align="center" bgcolor="#EFEFEF"><table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr>
              <td colspan="2">Imagem:<br />
                <?php if($rsnoticia['imagem']) { ?><img src="<?php echo '../'.IMG_INSTI.$rsnoticia['imagem']; ?>" alt="" width="70" height="56" border="0"/>
