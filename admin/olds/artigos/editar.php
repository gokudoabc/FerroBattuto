<br/><br/><br/>
<?php $sqlnoticia = $mySQL->runQuery("SELECT * FROM  for_prof_saude WHERE idartigo='".$_GET['id']."'");
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="4">
        <tr>
          <td colspan="3"><h1><em>Editar Artigo - Profissionais de sa&uacute;de</em>
        ...
        <tr>
          <td colspan="2" align="center" bgcolor="#EFEFEF"><table width="95%" border="0" align="center" cellpadding="3" cellspacing="3">
			...
			?>
                        ...
                        <tr>
              <td colspan="2"><br />Referencias:<br />
                <div style="width:670px;">
                  <?php
				$oFCKeditor = new FCKeditor('referencia') ;
				$oFCKeditor->BasePath = '_js/fckeditor/' ;
				$oFCKeditor->Config['SkinPath'] = 'skins/silver/' ;
				$oFCKeditor->Value = $rsnoticia['referencia'];
				$oFCKeditor->Create() ;
			?>
                </div></td>
            </tr>
