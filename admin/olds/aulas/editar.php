<br/><br/><br/>
<?php $sqlnoticia = $mySQL->runQuery("SELECT * FROM  neo_aulas WHERE idaulas='".$_GET['id']."'");
      ...
      <form action="aulas/action.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
      	 <input name="opt" type="hidden" id="opt" value="editar" />
            <input name="idaulas" type="hidden" id="idaulas" value="<?php echo $rsnoticia['idaulas']; ?>" />
            <input name="arq_old" type="hidden" id="arq_old" value="<?php echo $rsnoticia['arquivo']; ?>" />  
                                                <input name="autor2" type="hidden" id="autor2" value="<?php echo $_SESSION["nomeuser"]; ?>" />
    
      <table width="100%" border="0" cellspacing="0" cellpadding="4">
        <tr>
          <td colspan="3"><h1><em>Editar Aula médica - Profissionais de sa&uacute;de</em>
