<br/><br/><br/>
<?php $sqlnoticia = $mySQL->runQuery("SELECT * FROM for_paginas WHERE idpagina='4'");
			$rsnoticia = mysql_fetch_array($sqlnoticia);

			if ($_GET['id'] = 4)	{$paginaaberta = "Onde encontrar";}							
								
			?>
      <form action="paginas/action.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
      	 <input name="opt" type="hidden" id="opt" value="editar" />
            <input name="idpagina" type="hidden" id="idpagina" value="4" />
            <input name="img_old" type="hidden" id="img_old" value="<?php echo $rsnoticia['imagem']; ?>" />      

      <table width="100%" border="0" cellspacing="0" cellpadding="4">
        <tr>
          <td colspan="3"><h1><em>Editar <?php echo $paginaaberta; ?></em>
