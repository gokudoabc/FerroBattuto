<br/><br/><br/>
<?php $sqlnoticia = $mySQL->runQuery("SELECT * FROM clt_categorias WHERE idcategoria='".$_GET['id']."'");
			$rsnoticia = mysql_fetch_array($sqlnoticia);
															?>
      <form action="categorias/action.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
